/**
 * The command abstract class is used to ensure that all the classes have implementations of the methods and have
 * the implementation of isExit().
 *
...
public abstract class Command {
    ...
    /**
     * This command function is to set exit to false, in order to continue the exection of the program
     *
     */
    public Command() {
        exit = false;
    ...
    /**
     * This command function is to set exit to true, in order to terminate the program
     *
     */
